<div class="space-y-4">
    ...
    <label class="flex flex-col">
        ...
        <input class="rounded-md shadow-sm border-slate-300 dark:text-slate-400 dark:placeholder:text-slate-400"
    ...
    <label class="flex flex-col">
        ...
        <textarea class="rounded-md shadow-sm border-slate-300 dark:text-slate-400 dark:placeholder:text-slate-400"
